...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("[local] [origin (departure)] -> [destination (arrival)]");
        System.out.println(t1);
        System.out.println(t2);
        System.out.println(t3);
        System.out.println("Pret cursa 1: " + t1.ticket() + " ron");
        System.out.println("Pret cursa 2: " + t2.ticket() + " ron");
        System.out.println("Pret cursa 3: " + t3.ticket() + " ron");
